...
class VoltageCurrent(Device):
    ...
    def __init__(self, uid):
        ...
        self.expected_name = 'Voltage/Current Bricklet'

        self.binding_version = [1, 0, 0]

        self.callback_formats[VoltageCurrent.CALLBACK_CURRENT] = 'i'
        self.callback_formats[VoltageCurrent.CALLBACK_VOLTAGE] = 'i'
        self.callback_formats[VoltageCurrent.CALLBACK_POWER] = 'i'
        self.callback_formats[VoltageCurrent.CALLBACK_CURRENT_REACHED] = 'i'
        self.callback_formats[VoltageCurrent.CALLBACK_VOLTAGE_REACHED] = 'i'
        self.callback_formats[VoltageCurrent.CALLBACK_POWER_REACHED] = 'i'
    ...
    def get_current(self):
        ...
        """
        return self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_CURRENT, (), '', 'i')
    ...
    def get_voltage(self):
        ...
        """
        return self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_VOLTAGE, (), '', 'i')
    ...
    def get_power(self):
        ...
        """
        return self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_POWER, (), '', 'i')
    ...
    def set_configuration(self, averaging, voltage_conversion_time, current_conversion_time):
        ...
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_CONFIGURATION, (averaging, voltage_conversion_time, current_conversion_time), 'B B B', '')

    def get_configuration(self):
        """
        Returns the configuration as set by :func:`SetConfiguration`.
        """
        return GetConfiguration(*self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_CONFIGURATION, (), '', 'B B B'))
    ...
    def set_calibration(self, gain_multiplier, gain_divisor):
        ...
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_CALIBRATION, (gain_multiplier, gain_divisor), 'H H', '')

    def get_calibration(self):
        """
        Returns the calibration as set by :func:`SetCalibration`.
        """
        return GetCalibration(*self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_CALIBRATION, (), '', 'H H'))
    ...
    def set_current_callback_period(self, period):
        ...
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_CURRENT_CALLBACK_PERIOD, (period,), 'I', '')

    def get_current_callback_period(self):
        """
        Returns the period as set by :func:`SetCurrentCallbackPeriod`.
        """
        return self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_CURRENT_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_voltage_callback_period(self, period):
        ...
        The default value is 0.
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_VOLTAGE_CALLBACK_PERIOD, (period,), 'I', '')

    def get_voltage_callback_period(self):
        """
        Returns the period as set by :func:`SetVoltageCallbackPeriod`.
        """
        return self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_VOLTAGE_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_power_callback_period(self, period):
        ...
        The default value is 0.
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_POWER_CALLBACK_PERIOD, (period,), 'I', '')

    def get_power_callback_period(self):
        """
        Returns the period as set by :func:`GetPowerCallbackPeriod`.
        """
        return self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_POWER_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_current_callback_threshold(self, option, min, max):
        ...
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_CURRENT_CALLBACK_THRESHOLD, (option, min, max), 'c i i', '')

    def get_current_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetCurrentCallbackThreshold`.
        """
        return GetCurrentCallbackThreshold(*self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_CURRENT_CALLBACK_THRESHOLD, (), '', 'c i i'))
    ...
    def set_voltage_callback_threshold(self, option, min, max):
        ...
        The default value is ('x', 0, 0).
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_VOLTAGE_CALLBACK_THRESHOLD, (option, min, max), 'c i i', '')

    def get_voltage_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetVoltageCallbackThreshold`.
        """
        return GetVoltageCallbackThreshold(*self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_VOLTAGE_CALLBACK_THRESHOLD, (), '', 'c i i'))
    ...
    def set_power_callback_threshold(self, option, min, max):
        ...
        The default value is ('x', 0, 0).
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_POWER_CALLBACK_THRESHOLD, (option, min, max), 'c i i', '')

    def get_power_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetPowerCallbackThreshold`.
        """
        return GetPowerCallbackThreshold(*self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_POWER_CALLBACK_THRESHOLD, (), '', 'c i i'))
    ...
    def set_debounce_period(self, debounce):
        ...
        """
        self.ipcon.send_request(self, VoltageCurrent.FUNCTION_SET_DEBOUNCE_PERIOD, (debounce,), 'I', '')

    def get_debounce_period(self):
        """
        Returns the debounce period as set by :func:`SetDebouncePeriod`.
        """
        return self.ipcon.send_request(self, VoltageCurrent.FUNCTION_GET_DEBOUNCE_PERIOD, (), '', 'I')
