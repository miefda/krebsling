...
class LCD16x2(Device):
    ...
    def __init__(self, uid):
        ...
        self.callback_formats[LCD16x2.CALLBACK_BUTTON_PRESSED] = 'B'
        self.callback_formats[LCD16x2.CALLBACK_BUTTON_RELEASED] = 'B'
    ...
    def write_line(self, line, position, text):
        ...
        """
        self.ipcon.send_request(self, LCD16x2.FUNCTION_WRITE_LINE, (line, position, text), 'B B 16s', '')

    def clear_display(self):
        """
        Deletes all characters from the display.
        """
        self.ipcon.send_request(self, LCD16x2.FUNCTION_CLEAR_DISPLAY, (), '', '')

    def backlight_on(self):
        """
        Turns the backlight on.
        """
        self.ipcon.send_request(self, LCD16x2.FUNCTION_BACKLIGHT_ON, (), '', '')

    def backlight_off(self):
        """
        Turns the backlight off.
        """
        self.ipcon.send_request(self, LCD16x2.FUNCTION_BACKLIGHT_OFF, (), '', '')

    def is_backlight_on(self):
        """
        Returns *true* if the backlight is on and *false* otherwise.
        """
        return self.ipcon.send_request(self, LCD16x2.FUNCTION_IS_BACKLIGHT_ON, (), '', '?')
    ...
    def set_config(self, cursor, blinking):
        ...
        """
        self.ipcon.send_request(self, LCD16x2.FUNCTION_SET_CONFIG, (cursor, blinking), '? ?', '')

    def get_config(self):
        """
        Returns the configuration as set by :func:`SetConfig`.
        """
        return GetConfig(*self.ipcon.send_request(self, LCD16x2.FUNCTION_GET_CONFIG, (), '', '? ?'))
    ...
    def is_button_pressed(self, button):
        ...
        """
        return self.ipcon.send_request(self, LCD16x2.FUNCTION_IS_BUTTON_PRESSED, (button,), 'B', '?')
