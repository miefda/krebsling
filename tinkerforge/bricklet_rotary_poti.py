...
class RotaryPoti(Device):
    ...
    def __init__(self, uid):
        ...
        self.expected_name = 'Rotary Poti Bricklet'

        self.binding_version = [1, 0, 0]

        self.callback_formats[RotaryPoti.CALLBACK_POSITION] = 'h'
        self.callback_formats[RotaryPoti.CALLBACK_ANALOG_VALUE] = 'H'
        self.callback_formats[RotaryPoti.CALLBACK_POSITION_REACHED] = 'h'
        self.callback_formats[RotaryPoti.CALLBACK_ANALOG_VALUE_REACHED] = 'H'
    ...
    def get_position(self):
        ...
        """
        return self.ipcon.send_request(self, RotaryPoti.FUNCTION_GET_POSITION, (), '', 'h')
    ...
    def get_analog_value(self):
        ...
        """
        return self.ipcon.send_request(self, RotaryPoti.FUNCTION_GET_ANALOG_VALUE, (), '', 'H')
    ...
    def set_position_callback_period(self, period):
        ...
        """
        self.ipcon.send_request(self, RotaryPoti.FUNCTION_SET_POSITION_CALLBACK_PERIOD, (period,), 'I', '')

    def get_position_callback_period(self):
        """
        Returns the period as set by :func:`SetPositionCallbackPeriod`.
        """
        return self.ipcon.send_request(self, RotaryPoti.FUNCTION_GET_POSITION_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_analog_value_callback_period(self, period):
        ...
        The default value is 0.
        """
        self.ipcon.send_request(self, RotaryPoti.FUNCTION_SET_ANALOG_VALUE_CALLBACK_PERIOD, (period,), 'I', '')

    def get_analog_value_callback_period(self):
        """
        Returns the period as set by :func:`SetAnalogValueCallbackPeriod`.
        """
        return self.ipcon.send_request(self, RotaryPoti.FUNCTION_GET_ANALOG_VALUE_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_position_callback_threshold(self, option, min, max):
        ...
        """
        self.ipcon.send_request(self, RotaryPoti.FUNCTION_SET_POSITION_CALLBACK_THRESHOLD, (option, min, max), 'c h h', '')

    def get_position_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetPositionCallbackThreshold`.
        """
        return GetPositionCallbackThreshold(*self.ipcon.send_request(self, RotaryPoti.FUNCTION_GET_POSITION_CALLBACK_THRESHOLD, (), '', 'c h h'))
    ...
    def set_analog_value_callback_threshold(self, option, min, max):
        ...
        The default value is ('x', 0, 0).
        """
        self.ipcon.send_request(self, RotaryPoti.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD, (option, min, max), 'c H H', '')

    def get_analog_value_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetAnalogValueCallbackThreshold`.
        """
        return GetAnalogValueCallbackThreshold(*self.ipcon.send_request(self, RotaryPoti.FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD, (), '', 'c H H'))
    ...
    def set_debounce_period(self, debounce):
        ...
        """
        self.ipcon.send_request(self, RotaryPoti.FUNCTION_SET_DEBOUNCE_PERIOD, (debounce,), 'I', '')

    def get_debounce_period(self):
        """
        Returns the debounce period as set by :func:`SetDebouncePeriod`.
        """
        return self.ipcon.send_request(self, RotaryPoti.FUNCTION_GET_DEBOUNCE_PERIOD, (), '', 'I')
